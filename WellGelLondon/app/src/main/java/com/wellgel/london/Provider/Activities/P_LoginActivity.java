...
public class P_LoginActivity extends AppCompatActivity {
    ...
    private P_LoginActivity activity;
    ...
    private void OnClickHandle() {
        ...
        c_login_forgot_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(P_LoginActivity.this, C_ForgotPasswordAct.class));
            }
        });
        c_login_register_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(P_LoginActivity.this, P_RegisterActivity.class));
            }
        });
    ...
    public void loginApi(String st_email, String st_pass) {
        ...
        Call<LoginSerialized> call = service.login(st_email, st_pass, "android", "mydevice");
...
//                            shared.setString("token", imageURL + response.body().getData().getToken());
                    ...
                    try {
                        ...
                        if (loginType.equalsIgnoreCase("facebook") || loginType.equalsIgnoreCase("google")) {
                            startActivity(new Intent(activity, P_RegisterActivity.class));
                        }
