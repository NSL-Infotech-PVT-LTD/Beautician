...
public class NailPolishColorAdapter extends RecyclerView.Adapter<NailPolishColorAdapter.MyViewHolder> {
    ...
    public interface onItemClickListener {
        void onPerformClick(int i, View view, String colorname);
    }

    public NailPolishColorAdapter(Context context, String FLAG, ArrayList<String> list, onItemClickListener listener) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.image.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                NailPolishColorAdapter.this.notifyItemChanged(NailPolishColorAdapter.selectedPosition);
                NailPolishColorAdapter.this.listener.onPerformClick(position, v, list.get(position));
            }
        });
    }
