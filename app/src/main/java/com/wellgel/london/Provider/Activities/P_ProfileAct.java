...
public class P_ProfileAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p__profile);
        init();
    }
    ...
    private void init() {
        ...
        update_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(activity, P_UpdateProfileFra.class));
            }
        });
