...
//        return bookHolder;
    ...
    public void addItems(List<C_Product_model> postItems) {
    ...
    public void removeLoading() {
        ...
        C_Product_model item = getItem(position);
        if (item != null) {
    ...
    C_Product_model getItem(int position) {
