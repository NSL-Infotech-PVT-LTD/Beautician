...
public class C_ProductsDetailAct extends AppCompatActivity {
    ...
    private TextView c_product_name, c_product_price, buyNow;
                ...
                if (response.body() != null) {
                    if (response.isSuccessful()) {
                        ...
                        if (response.body().getStatus()) {
                            ...
                            if (isAdded > 0) {
                                addtocart.setText("Add More to Cart");
                            } else {
    ...
    public void updateCart(String productID, String cartOption, String cartQantity) {
        ...
        /*Create handle for the RetrofitInstance interface*/
        progressDoalog = new ProgressDialog(activity);
        progressDoalog.setMessage("Updating cart....");
        progressDoalog.show();
        Customer_APIs service = RetrofitClientInstance.getRetrofitInstance().create(Customer_APIs.class);
    ...
    public void addToCartApi() {
        progressDoalog = new ProgressDialog(activity);
        progressDoalog.setMessage("Adding into cart....");
        progressDoalog.show();
