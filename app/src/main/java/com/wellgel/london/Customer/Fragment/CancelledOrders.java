...
public class CancelledOrders extends Fragment {
    private RecyclerView cancelled_recycler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cancelled_recycler = view.findViewById(R.id.cancelled_recycler);
        shared = new PreferencesShared(context);
//        bookedAdpter = new C_Booked_OrderAdapter(getActivity(), bookedList);
//        cancelled_recycler.setAdapter(bookedAdpter);
                ...
                if (response.body() != null) {
                    if (response.isSuccessful()) {
                        if (response.body().getStatus()) {
                            ...
                            cancelled_recycler.setAdapter(bookedAdpterProvider);
                        } else {
                        }
