...
public class ApprovedOrders extends Fragment {
    private RecyclerView approved_recycler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        approved_recycler = view.findViewById(R.id.approved_recycler);
        shared = new PreferencesShared(context);
//        bookedAdpter = new C_Booked_OrderAdapter(getActivity(), bookedList);
//        approved_recycler.setAdapter(bookedAdpter);
                ...
                if (response.body() != null) {
                    if (response.isSuccessful()) {
                        if (response.body().getStatus()) {
                            ...
                            approved_recycler.setAdapter(bookedAdpterProvider);
                        } else {
                        }
